...
export default function CompanyIntro() {
  return (
    <section className="py-20 dark:bg-[#050505] bg-gray-50">
      <div className="max-w-[1440px] mx-auto px-6">
        {/* Header */}
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold dark:text-white text-black mb-4">ofubest</h2>
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-base dark:text-white text-black/70 leading-relaxed text-left mt-4">
            基于这些自研模型，我们面向全球推出一系列 AI
            原生产品，包括 ofubest Agent、海螺AI、ofubest Audio、星野等，以及面向企业和开发者的开放平台，共同为全球用户提供极致的智能体验。
          </p>
        </div>
        ...
        <div className="grid grid-cols-4 gap-8 px-12 max-w-5xl mx-auto">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="text-4xl font-bold dark:text-white text-black mb-2">
                {stat.number}
              </div>
              <div className="text-sm dark:text-white text-black/50">{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
